...
const CustomerDetails = ({ customer, onBack }) => {
  ...
  return (
    <div className="fixed inset-0 z-20 bg-gray-50 flex flex-col overflow-hidden">
      {/* Header - Fixed at top */}
      <div className="bg-white border-b border-gray-200 px-4 py-4 flex items-center gap-3 shadow-sm flex-shrink-0">
